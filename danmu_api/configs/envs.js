...
如果没有找到合适的匹配，返回：
{
  ...
  static resolveSourceOrder() {
    let sourceOrder = this.get('SOURCE_ORDER', '360,vod,renren,hanjutv,maiduidui,bilibili,iqiyi,tencent,youku,migu', 'string');
    ...
    return orderArr.length > 0 ? orderArr : ['360', 'vod', 'renren', 'hanjutv','maiduidui','bilibili','iqiyi','tencent','youku','migu'];
  }
